...
public class Zmienne {
	...
	// void states that this function doesn't return any values after it is done
	// executing
	// main is required in every Java program. This function is always executed
	// first
	// Every main function must accept an array of string objects

	// Class variables must start with static if you want to access them with any
	...
	public static void main(String[] args) {
		...
		/*
		 * You can use any variable name except for abstract continue for new switch
		 ...
		 * static void class finally long strictfp volatile const float native super
		 * while
		 */
		...
		// kompilator ignoruje biale znaki, spacje i odstepy, po odzielenie przynajmniej
		// jedną
		...
		// If you convert from a number that is to big the largest possible value will
		// be
		// used instead
		...
		/*
		 * To cast to other primitive types just proceed with the conversion to type ie
		 * (byte) (short) (long) (double) (float) & (boolean) & (char) don't work.
		...
		/*
		 * Other parse functions parseShort, parseLong, parseByte, parseFloat,
